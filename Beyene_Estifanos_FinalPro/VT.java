public class VT {//class for Virginia Tech
	private final String [] semester1 = {"SDV 100", "ENG 111", "CST 100",
				"MTH 263", "Social Science Elective",
				"Humanities/Fine Arts Elective", "EGR 121"};
	private final String [] semester2 = {"ENG 112", "MTH 264", "PHY 231", 
				"CHM 111"};
	private final String [] semester3 = {"MTH 265", "PHY 232", "CSC 201", 
				"EGR 122","Social Science Elective"}; 
	private final String [] semester4 = {"MTH 267", "CSC 202", "MTH 266",
			"MTH 288", "Humanities/Fine Arts Elective"};
	private int current;
	
	public VT(int currentIn) {//constructor
